...
processCapability(q1, spec.limits=c(73.95,74.05))
processCapability(q1, spec.limits=c(73.95,74.05), target=74.02)
processCapability(q1, spec.limits=c(73.99,74.01))
processCapability(q1, spec.limits = c(73.99, 74.1))
```
